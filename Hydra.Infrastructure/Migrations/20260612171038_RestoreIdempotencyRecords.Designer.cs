...
namespace Hydra.Infrastructure.Migrations
{
    ...
    [Migration("20260612171038_RestoreIdempotencyRecords")]
    partial class RestoreIdempotencyRecords
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "idempotency_state", new[] { "PROCESSING", "COMPLETED", "FAILED" });
            ...
            modelBuilder.Entity("Hydra.Domain.Entities.User", b =>
                {
                    ...
                    b.HasIndex(new[] { "TenantId", "DocumentNumber" }, "uq_users_tenant_document_number")
                        .IsUnique();
